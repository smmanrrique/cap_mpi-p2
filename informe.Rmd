...
#------------------------------------------------------------------------------#
# Resumen estadisticos de los datos generales 
...
#------------------------------------------------------------------------------#
# Filtra los tiempos medido por los receptores.
...
Boxplot(COM_TIME~NPROC, data=rs_latency, id=list(method="y"),outline=FALSE, xlab="Number of Process", ylab="Time")

#------------------------------------------------------------------------------#
# Filtra los tiempos medido por los emisores iniciales.
...
# Resumen estadistico
Boxplot(COM_TIME~NPROC, data=sr_latency, id=list(method="y"),outline=FALSE, xlab="Number of Process", ylab="Time")

x = filter(sr_latency, NPROC==4 | NPROC==8)

# Prueba de normalidad por groupo
normalityTest(COM_TIME, test="shapiro.test", data=x) # Shapiro
normalityTest(sr_latency$NPROC~sr_latency$COM_TIME, test="ad.test", data=Dataset)   # Anderson-Darling


# qqPlot para la validación de normalidad
with(sr_latency, qqPlot(sr_latency$COM_TIME, dist="norm", id=list(method="y", n=2, labels=rownames(COM_TIME))))
...
# 
Boxplot(COM_TIME~NPROC, data=bandwidth, id=list(method="y"), xlab="Number of Process", ylab="Time")
...
Boxplot(COM_TIME~NPROC, data=broadcast, id=list(method="y"), xlab="Number of Process", ylab="Time")
